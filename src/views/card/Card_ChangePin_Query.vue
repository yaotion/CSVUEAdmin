  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="原因" prop="ChangeReason" align="center" />
      </el-table>
    </div>
  </div>
</template>
...
<script>
import { cardChangePinQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      cardChangePinQuery(this.listQuery).then(response => {
