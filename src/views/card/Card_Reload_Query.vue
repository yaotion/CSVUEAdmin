  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="原因" prop="ReloadReason" align="center" />
      </el-table>
    </div>
  </div>
</template>
...
<script>
import { cardReloadQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      cardReloadQuery(this.listQuery).then(response => {
