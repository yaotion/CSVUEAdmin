  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="金额" prop="ChangeMoney" align="center" width="100" />
        <el-table-column label="源账户编号" prop="SrcAccNo" align="center" width="115" />
        <el-table-column label="源账户名称" prop="SrcAccName" align="center" width="80" />
        <el-table-column label="目标账户编号" prop="DesAccNo" align="center" width="80" />
        <el-table-column label="源账户金额" prop="SrcAccNoAmt" align="center" width="80" />
        <el-table-column label="目标账户金额" prop="DesAccNoAmt" align="center" width="80" />
        <el-table-column label="持卡人" prop="MasterName" align="center" width="80" />
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      custChangeMoneyQuery(this.listQuery).then(response => {
