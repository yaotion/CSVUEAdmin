<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="单位名称" prop="AccName" width="150" align="center" />
      <el-table-column label="开户行" prop="BankName" align="center" />
      <el-table-column label="银行账号" prop="BankAccNo" align="center" width="180" />
    </el-table>
  </div>
</template>

<script>
import { custCreateQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      custCreateQuery(this.listQuery).then(response => {
