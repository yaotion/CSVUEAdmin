<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="卡号" prop="CardNo" align="center" width="115" />
      <el-table-column label="持卡人" prop="HolderName" align="center" width="90" />
      <el-table-column label="金额" prop="SaveMoney" align="center" width="90" />
      <el-table-column label="余额" prop="CardAmt" align="center" width="90" />
    </el-table>
...
<script>
import { userUnDepositTrade } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      userUnDepositTrade(this.listQuery).then(response => {
