  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="人员" prop="Memo" align="center" width="80" />
        <el-table-column label="挂失原因" prop="LossReason" align="center" />
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      userLosscardTrade(this.listQuery).then(response => {
