  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="单据编号" prop="FrmId" align="center" width="120" />
        <el-table-column label="操作员" prop="OptName" align="center" width="100">
          <template slot-scope="scope2">
            <span>{{ scope2.row.OptName +'|'+ scope2.row.OptNo }}</span>
          </template>
        </el-table-column>
        <el-table-column label="时间" prop="OptTime" align="center" width="９０" />
        ...
        <el-table-column label="退卡原因" prop="LossReason" align="center" />
...
<script>
import { cardReturnWCQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      cardReturnWCQuery(this.listQuery).then(response => {
