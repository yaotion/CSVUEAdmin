<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="卡账编号" prop="AccNo" align="center" width="150" />
      <el-table-column label="金额" prop="DepositMoney" align="center" width="80" />
      <el-table-column label="卡余额" prop="CardAmt" align="center" width="80" />
...
<script>
import { custUnDepositQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      custUnDepositQuery(this.listQuery).then(response => {
