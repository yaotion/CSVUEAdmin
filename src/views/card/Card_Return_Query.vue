  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="单据编号" prop="FrmId" align="center" width="100" />
        ...
        <el-table-column label="金额" prop="ReturnMoney" align="center" width="80" />
        <el-table-column label="返还形式" prop="PAYTYPE" align="center" width="80" />
        <el-table-column label="原因" prop="ReturnReason" align="center" />
...
<script>
import { cardReturnQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.listLoading = true
      cardReturnQuery(this.listQuery).then(response => {
