<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="单据号" prop="FrmId" align="center" width="80" />
      ...
      <el-table-column label="金额" prop="SaveMoney" align="center" width="80" />
      <el-table-column label="余额" prop="CardAmt" align="center" width="80" />
      <el-table-column label="支付方式" prop="PAYTYPE" align="center" width="60" />
      <el-table-column label="实收金额" prop="SaveMoneyBase" align="center" width="80" />
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      userDepositTrade(this.listQuery).then(response => {
