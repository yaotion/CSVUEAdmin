<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="原卡号" prop="CardNo" align="center" width="160" />
      <el-table-column label="新卡号" prop="NewCardNo" align="center" width="160" />
...
<script>
import { userRecardTrade } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      userRecardTrade(this.listQuery).then(response => {
