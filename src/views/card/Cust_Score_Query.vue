  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="获得积分" prop="ScoreIn" align="center" width="100" />
        <el-table-column label="使用积分" prop="ScoreOut" align="center" width="100" />
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['序号', '账号', '账户名称', '获得积分', '使用积分', '剩余积分']
        const filterVal = ['index', 'AccNo', 'AccName', 'ScoreIn', 'ScoreOut', 'ScoreBalance']
