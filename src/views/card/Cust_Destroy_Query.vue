  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="账户编号" prop="DestroyAccNo" align="center" width="100" />
        <el-table-column label="账户名称" prop="DestroyAccName" align="center" width="220" />
        <el-table-column label="余额" prop="ReturnMoney" align="center" width="90" />
      </el-table>
    </div>
  </div>
</template>
...
<script>
import { custDestroyQuery } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.listLoading = true
      custDestroyQuery(this.listQuery).then(response => {
