  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="原因" prop="LossReason" align="center" />
      </el-table>
    </div>
...
<script>
import { userUnLosscardTrade } from '@/api/card'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      userUnLosscardTrade(this.listQuery).then(response => {
