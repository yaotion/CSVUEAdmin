  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="员工姓名" prop="EmpName" align="center" width="120" />
        <el-table-column label="员工号" prop="EmpNo" align="center" width="100" />
        <el-table-column label="卡号" prop="CardNo" align="center" width="200" />
        <el-table-column label="证件号" prop="CerNo" align="center" width="200" />
      </el-table>
    </div>
...
<script>
import { stationEmpCardQuery } from '@/api/station'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      stationEmpCardQuery(this.listQuery).then(response => {
