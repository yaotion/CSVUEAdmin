  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="油机号" prop="Mach_No" align="center" width="80" />
        <el-table-column label="端口号" prop="Port_No" align="center" width="80" />
        <el-table-column label="机型" prop="Mach_Type" align="center" width="100" />
        <el-table-column label="罐号" prop="Tank_No" align="center" width="80" />
        <el-table-column label="油品名称" prop="Oil_Name" align="center" width="120" />
