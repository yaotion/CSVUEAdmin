  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="操作员编号" prop="OptNo" align="center" width="80" />
        <el-table-column label="操作员姓名" prop="OptName" align="center" width="80" />

        <el-table-column label="商务日期" prop="BussDate" align="center" width="90" />
        <el-table-column label="班号" prop="ShiftNo" align="center" width="60" />
        <el-table-column label="油罐号" prop="TankNo" align="center" width="60" />
        <el-table-column label="报警类型" prop="AlarmType" align="center" width="100" />
        <el-table-column label="报警开始时间" prop="AlartStartTime" align="center" width="90" />
        <el-table-column label="报警结束时间" prop="AlartEndTime" align="center" width="90" />
        <el-table-column label="水高" prop="WaterHeight" align="center" width="70" />
        <el-table-column label="油高" prop="OilHeight" align="center" width="70" />
        <el-table-column label="温度" prop="Temp" align="center" width="70" />
      </el-table>
    </div>
...
<script>
import { stationTankAlarmQuery } from '@/api/station'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      stationTankAlarmQuery(this.listQuery).then(response => {
