  ...
  <div class="app-container">
    ...
    <div id="tablePrint" ref="print">
      ...
      >
        ...
        <el-table-column label="操作员编号" prop="Emp_No" align="center" width="80" />
        <el-table-column label="商务日期" prop="Buss_Date" align="center" width="90" />
        <el-table-column label="班号" prop="Shift_No" align="center" width="60" />
        <el-table-column label="油罐号" prop="Tank_No" align="center" width="60" />
        <el-table-column label="报警类型" prop="Alarm_Type" align="center" width="100" />
        <el-table-column label="报警开始时间" prop="Start_Time" align="center" width="90" />
        <el-table-column label="报警结束时间" prop="End_Time" align="center" width="90" />
        <el-table-column label="水高" prop="Water_Height" align="center" width="70" />
        <el-table-column label="油高" prop="Oil_Height" align="center" width="70" />
        <el-table-column label="温度" prop="Oil_Temp" align="center" width="70" />
      </el-table>
    </div>
  </div>
</template>
